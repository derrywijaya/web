...
import { IDropdown } from './models.service';

@Injectable({
  providedIn: 'root'
})
export class ReffserviceService {

  private languages: IDropdown[] = [
    { code: "aa", name: "Afar" },
  ...
  getLanguages(): Observable<any> {
    return observableOf(this.languages.sort((a, b) => (a.name > b.name) ? 1 : -1));
  }
}
